/*
Cheesy Cheeseman just got a new monitor! 
He is happy with it, but he just discovered that his old desktop wallpaper no longer fits. 
...
const findScreenHeight = (width, ratio, [w, h] = ratio.split(':')) => `${width}x${(width * h / w)}`;